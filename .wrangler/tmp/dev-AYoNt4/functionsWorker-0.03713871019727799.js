...
// .wrangler/tmp/pages-Xk86Sh/functionsWorker-0.03713871019727799.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
async function onRequestPost(context) {
  try {
    let parseStock = /* @__PURE__ */ __name(function(stockStr) {
      if (stockStr === null || stockStr === void 0) return 0;
      const num = parseInt(String(stockStr).replace(/[^0-9]/g, ""), 10);
      return isNaN(num) ? 0 : num;
    }, "parseStock");
    __name2(parseStock, "parseStock");
    ...
    const MARGIN = parseFloat(env.PRICE_MARGIN) || 1.3;
      ...
      try {
        ...
        if (mouserResponse.ok) {
          try {
            ...
            mouserDebug.parseError = e.message;
          }
        }
      } catch (err) {
  ...
  try {
    ...
    if (env.DB) {
      try {
        ...
        `;
        const { results } = await env.DB.prepare(sql).bind(`%${queryNorm}%`, queryNorm).all();
        const seenMpn = /* @__PURE__ */ new Set();
        results.forEach((row) => {
...
// .wrangler/tmp/bundle-QyaFC9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QyaFC9/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.03713871019727799.js.map
